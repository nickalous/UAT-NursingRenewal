package company.RnLpn.Test_03;

import company.Admin.AdminLogin;
import company.Admin.AdminMenu;
import company.Admin.OpenRecords;
...
public class RnLpnTest_03{
    ...
    public void init() {
        ...
        try (FileInputStream f = new FileInputStream("C:\\Users\\Nickalous.Fulton\\Desktop\\NursingRenewal\\src\\main\\java\\company\\RnLpn\\Test_03/RnLpn_03.properties")) {
   ...
   // public void achVerify() {ACHverify achv = new ACHverify(this.driver, this.props);}
    ...
    @Test(priority = 26)
    public void adminLogin() {AdminLogin al = new AdminLogin(this.driver, this.props);}

    @Test(priority = 27)
    public void adminMenu() {AdminMenu admnmenu = new AdminMenu(this.driver, this.props);}

    @Test(priority = 28)
    public void openRecord() {OpenRecords opnr = new OpenRecords(this.driver, this.props);}
