...
//RX True
    ...
    public void init() {
        ...
        try (FileInputStream f = new FileInputStream("C:\\Users\\Nickalous.Fulton\\Desktop\\NursingRenewal\\src\\main\\java\\company\\RnLpn\\Test_01/RnLpn.properties")) {
    ...
    @Test(priority = 2)
    public void RnLpnverify(){ RnLpnVerify ver = new RnLpnVerify(this.driver, this.props);}
